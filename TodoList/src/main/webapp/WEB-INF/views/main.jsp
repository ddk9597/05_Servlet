...
<%-- JSTL(Jsp Standard Tag Library) 
    - JSP에서 자주 사용하는 Java 기능(if, for, String, 숫자관련기능, 날짜관련 기능 등)을  태그 형식으로 만들어 제공
    - JSP 개발을 간소화하고 유지 관리를 용이하게 하는 강력한 도구
    -> Spring Boot에서는 사용 불가함.. 
    
--%>  

<%-- JSTL 라이브러리를 현재 JSP 에 사용 하겠다는 JSP 지시자 작성 --%>
...
<body>
 ...
 <form action="/todo/add"> <!-- method 미작성시 기본값인 GET방식 요청 적용 -->
   <h4> 할 일 추가 </h4>
   <div>
  ...
  <table border = "1" style = "border-collapse : collapse" >
   ...
   <!--
    ...
    <%-- sessionScope에 message 속성이 있다면 --%>
    <c:if test="${not empty sessionScope.message }"> 
	   <script>
	   	// EL을 이용해서 String을 추가할 때 꼭 "" 추가하기!
